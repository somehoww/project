...
<body>
    <nav>
        <label class="logo" id="logo">Vibe</label>
        <ul>
    ...
    <footer>
        <div class="social">
            <a href="https://www.facebook.com/profile.php?id=100004974705411"><i class="fa fa-facebook" aria-hidden="true"></i></a>
